...
function onBtnAddClick() {
  ...
  $("#modal-add-edit-order").modal("show");
  // hiển thị sẵn customer id khi thêm mới (sau khi từ page customer admin sang)
  console.log(gCustomerId)
  if (gCustomerId != null) {
    $("#input-customer_id").attr('disabled', 'disabled').val(gCustomerId);
  }
}
