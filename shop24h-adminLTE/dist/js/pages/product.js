  ...
  columnDefs: [
    ...
    },
    {
      ...
      render: function (data) {
        return `<img src='/shop24h-frontend/vegefoods-master/${data}' alt=${data} height="150"></img>`;
      }
    },
    {
      targets: 10,
...
function onBtnEditClick(paramEdit) {
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      $("#input-productSize").val(res.productSize);
      $("#input-image").val(res.image);
...
function validateData(paramObj) {
  ...
  if (paramObj.productSize == "") {
    toastr.error("Thiếu productSize &#128545;");
    return false;
  }
  ...
  if (isNaN(paramObj.buyPrice)) {
    toastr.error("productSize phải là một số! &#128545;");
    return false;
  }
